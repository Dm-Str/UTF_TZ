# Generated by Django 5.0.7 on 2024-08-02 21:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional', models.ManyToManyField(blank=True, related_name='additional_from', to='test_task.food', verbose_name='Дополнительные товары')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='food', to='test_task.foodcategory', verbose_name='Раздел меню')),
            ],
            options={
                'abstract': False,
            },
